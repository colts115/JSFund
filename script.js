...
let lenShortFoodNames = shortFoodNames.length;
let lenLongFoodNames = longFoodNames.length;

console.log(longFoodNames);
console.log(shortFoodNames);

if (lenLongFoodNames > lenShortFoodNames){
  console.log("There are more long named foods");
}
if (lenShortFoodNames > lenLongFoodNames){
...
console.log("The longest food is " + longestFood + " with " + longestFood.length + " characters.");
